...
struct Kalendorius: View {
    ...
    init() {
        ...
        sv_spalva[1] = sp1
        sv_spalva[2] = sp2
        //print("90_D",lit_color)
        if(ausrin.isEmpty) {
            setDateString()
            sapka()
            lit_colorx = lit_color
        }
        print(97,"Kalendorius_init_D",dtime())
    ...
    func setDateString() {
     print(104,"Kalendorius_setDateString()_D",dtime())
    ...
    var body: some View {
        ...
        Form {
            ...
            Section(header: Text("Jūsų pasirinkimas paspaudimu:" )
                ...
                .border(pnr == 1 ? Color.gray :Color(lit_color_m), width: 3)
                .cornerRadius(10)
                ...
                if(!sv0.isEmpty) {
                    Text(sv0)
                        .frame(width: UIScreen.main.bounds.width/1.2, height: 25)
                        .background(Color(sp0))
                        .foregroundColor(.white)
                        .border(pnr == 2 ? Color.gray :Color(sp0), width: 3)
                        .cornerRadius(10)
                        .font(.footnote)
                        .contentShape(Rectangle())
                ...
                if(!sv1.isEmpty) {
                    ...
                    Text(sv1)
                        ...
                        .foregroundColor(.white)
                        .border(pnr == 3 ? Color.gray :Color(sp1), width: 3)
                        .cornerRadius(10)
                        .font(.footnote)
                        .contentShape(Rectangle())
                ...
                if(!sv2.isEmpty) {
                    Text(sv2)
                        ...
                        .foregroundColor(.white)
                        .border(pnr == 4 ? Color.gray :Color(sp2), width: 3)
                        .cornerRadius(10)
                        .font(.footnote)
                        .contentShape(Rectangle())
    ...
    func sapka() {
        ...
        if(pnr < 2) {
            ...
            sapkat +=  lit_laikas
            if(!lit_laikas2.isEmpty) {
                sapkat += "<br><small><span style='color:red'>" + lit_laikas2 + "</small></span>" }
            sapkat +=  "</p>" }
        if(pnr == 2) {
